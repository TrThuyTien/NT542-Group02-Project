...
module "iam" {
  depends_on    = [aws_cloudwatch_event_bus.shared, module.secrets]
  source        = "./modules/iam"
  project_name  = var.project_name
  secret_arn    = module.secrets.secret_arn
  kms_key_arn   = module.secrets.kms_key_arn
  event_bus_arn = aws_cloudwatch_event_bus.shared.arn
}

module "ecs" {
  depends_on   = [module.vpc, module.iam, module.secrets, aws_cloudwatch_event_bus.shared]
  source       = "./modules/ecs"
  project_name = var.project_name
